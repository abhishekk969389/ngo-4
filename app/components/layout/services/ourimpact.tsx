...
export default function OurImpact() {
  ...
  const getStatIcon = (icon: string) => {
    const IconComponent = statIconMap[icon as keyof typeof statIconMap] ?? Sparkles;
    return <IconComponent className="h-5 w-5 text-[#1b5e2d] sm:h-6 sm:w-6" />;
  };

  return (
    <section className="overflow-hidden bg-white ">
      {/* SVG Brush Mask Definition */}
      <svg className="absolute h-0 w-0" aria-hidden="true" focusable="false">
        <defs>
          <mask id="brush-stroke-mask" maskUnits="objectBoundingBox" maskContentUnits="objectBoundingBox">
            <path
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1fr_0.9fr]">
            ...
            <div className="relative z-10">
              ...
              <div className="mb-4 flex items-center gap-2">
                ...
                <svg className="h-5 w-5 text-[#1d5e2d]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="relative mx-auto w-full max-w-[480px]">
              ...
              {/* Main Image with Brush Stroke Mask */}
              ...
              <div className="relative z-10 -mt-16 sm:-mt-20">
                ...
                <div className="relative overflow-hidden rounded-[2rem] bg-[#143d18] px-6 pb-6 pt-14 text-white shadow-2xl sm:rounded-[2.5rem] sm:px-8 sm:pb-8 sm:pt-16">
                  <div className="flex flex-col items-start gap-4 pt-2 sm:flex-row sm:items-center sm:gap-6">
                    {/* 2x5 Dotted Grid Accent */}
                    <div className="hidden shrink-0 grid-cols-5 gap-1.5 opacity-40 sm:grid">
                      {[...Array(10)].map((_, i) => (
                        <div key={i} className="h-1.5 w-1.5 rounded-full bg-emerald-200" />
                      ))}
                    </div>
