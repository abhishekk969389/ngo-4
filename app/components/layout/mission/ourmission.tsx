...
export default function OurMission() {
  const missionData: MissionPageSection = data.missionPageSection || {
    ...
    description: "Our mission is to empower individuals and uplift communities by providing access to education, healthcare, and essential resources. We are committed to creating opportunities that inspire hope, restore dignity, and drive lasting change.",
    pillars: [
      {
        id: 1,
        title: "Educate",
        description: "We provide quality education and learning opportunities that help children break barriers and build a better tomorrow.",
        icon: "educate",
        themeColor: "#2c7a3f",
        bgColor: "#e6f4ea"
      },
      {
        id: 2,
        title: "Heal",
        description: "We promote good health and well-being by ensuring access to healthcare and spreading awareness in communities.",
        icon: "heal",
        themeColor: "#e06d2d",
        bgColor: "#fde9d9"
      },
      {
        id: 3,
        title: "Support",
        description: "We stand beside those in need with compassion, providing essential resources and emotional support to help them move forward.",
        icon: "support",
        themeColor: "#3b7bc4",
        bgColor: "#dcebfd"
      },
      {
        id: 4,
        title: "Empower",
        description: "We empower individuals and communities to become self-reliant and create lasting change for a better future.",
        icon: "empower",
        themeColor: "#8a4bb8",
        bgColor: "#ebdcf8"
      }
  ...
  const getPillarIcon = (iconName: string, themeColor: string) => {
    switch (iconName) {
      case 'educate':
        return <BookOpen className="w-6 h-6 sm:w-7 sm:h-7" style={{ color: themeColor }} />;
      case 'heal':
        return <HeartPulse className="w-6 h-6 sm:w-7 sm:h-7" style={{ color: themeColor }} />;
      case 'support':
        return <Users className="w-6 h-6 sm:w-7 sm:h-7" style={{ color: themeColor }} />;
      case 'empower':
        return <Sprout className="w-6 h-6 sm:w-7 sm:h-7" style={{ color: themeColor }} />;
      default:
        return <BookOpen className="w-6 h-6 sm:w-7 sm:h-7" style={{ color: themeColor }} />;
    }
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-12 lg:gap-10 xl:gap-14 items-center">
          ...
          <div className="relative lg:col-span-5 flex justify-center lg:justify-end mt-2 lg:mt-0">
            ...
            <div className="relative w-full max-w-[310px] xs:max-w-[350px] sm:max-w-[450px] pb-14 sm:pb-16 pt-2">
              ...
              {/* Main Image with Smooth Organic Blob Shape */}
              <div 
