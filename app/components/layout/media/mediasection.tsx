...
const renderIcon = (iconName: string) => {
  ...
  switch (iconName) {
    case 'feather':
      return (
        <div className={`flex h-11 w-11 shrink-0 items-center justify-center ${colorClass}`}>
    ...
    case 'landmark':
      return (
        <div className={`flex h-11 w-11 shrink-0 items-center justify-center ${colorClass}`}>
          <svg className="h-9 w-9" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
            ...
            <path d="M17 11v8" />
            <path d="M3 21h18" />
            <path d="M12 2L2 9h20L12 2z" fill="currentColor" fillOpacity="0.1" />
          </svg>
        </div>
      );
    ...
    case 'tree':
      return (
        <div className={`flex h-11 w-11 shrink-0 items-center justify-center ${colorClass}`}>
          <svg className="h-9 w-9" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
            <path d="M12 19v3" />
            <path d="M12 19c-4 0-7-2.5-7-6a7 7 0 0 1 14 0c0 3.5-3 6-7 6z" fill="currentColor" fillOpacity="0.15" />
    ...
    case 'pen-nib':
      return (
        <div className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-full border-2 border-[#1a3520] p-1.5 ${colorClass}`}>
