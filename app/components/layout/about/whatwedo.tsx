...
export default function WhatWeDo() {
  ...
  const getItemIcon = (iconName: string) => {
    switch (iconName) {
      case 'heart-hand':
        return <HandHeart className="w-5 h-5 sm:w-6 sm:h-6 text-[#2c7a3f] stroke-[1.8]" />;
      case 'droplets':
        return <Droplets className="w-5 h-5 sm:w-6 sm:h-6 text-[#2c7a3f] stroke-[1.8]" />;
      case 'graduation':
        return <GraduationCap className="w-5 h-5 sm:w-6 sm:h-6 text-[#2c7a3f] stroke-[1.8]" />;
      case 'medical':
        return <PlusSquare className="w-5 h-5 sm:w-6 sm:h-6 text-[#2c7a3f] stroke-[1.8]" />;
      case 'users':
        return <Users className="w-5 h-5 sm:w-6 sm:h-6 text-[#2c7a3f] stroke-[1.8]" />;
      case 'food':
        return <Utensils className="w-5 h-5 sm:w-6 sm:h-6 text-[#2c7a3f] stroke-[1.8]" />;
      default:
        return <HandHeart className="w-5 h-5 sm:w-6 sm:h-6 text-[#2c7a3f] stroke-[1.8]" />;
    }
  };
    ...
    <section className="bg-white mt-6 sm:mt-8 md:mt-10 lg:mt-14 overflow-hidden mb-8 sm:mb-10 lg:mb-12">
      <div className="mx-auto max-w-[1300px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-2 xl:gap-4 items-center">
          ...
          {/* Left Column: Heading, Description & 6-Items Grid */}
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <div className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-3 gap-0 border-t border-b border-gray-200/80 py-2 sm:py-4 max-w-2xl">
              {whatWeDoData.items.map((item: any, index: any) => {
                ...
                const isMobileBorderBottom = index < whatWeDoData.items.length - 1;
                ...
                return (
                  <div
                    ...
                    className={`flex flex-col items-center text-center p-3.5 sm:p-4 ${
                      ...
                      isMobileBorderBottom ? 'border-b sm:border-b-0 border-gray-100' : ''
                    }`}
                  >
          ...
          <div className="lg:col-span-5 flex justify-center items-center lg:justify-start py-2 sm:py-4">
            ...
            <div className="relative w-[290px] h-[410px] xs:w-[320px] xs:h-[450px] sm:w-[500px] sm:h-[620px] lg:w-[520px] lg:h-[640px]">
              ...
              {/* 2. RIGHT MIDDLE IMAGE (Boy Studying) */}
