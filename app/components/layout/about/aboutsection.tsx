          ...
          <div className="relative flex justify-center lg:justify-start lg:col-span-5 pb-6 sm:pb-8 lg:pb-0">
            ...
            <div className="absolute top-6 sm:top-9 -right-2 sm:-right-6 md:-right-8 lg:-right-10 z-0 grid grid-cols-4 gap-1.5 sm:gap-2 opacity-35 hidden sm:grid">
              {Array.from({ length: 12 }).map((_, i) => (
                <div key={i} className="w-2 sm:w-2.5 h-2 sm:h-2.5 rounded-full bg-[#8ca891]" />
              ))}
            </div>

            {/* Left Edge Small Leaf Doodle */}
            ...
            {/* Soft Light Green Backdrop Card */}
            ...
            {/* Green Dashed Curve Line Decor */}
            <div className="absolute -bottom-8 sm:-bottom-10 -left-4 sm:-left-6 z-10 hidden sm:block">
              <svg className="w-16 h-16 sm:w-24 sm:h-24 text-[#2c7a3f] opacity-85" viewBox="0 0 100 100" fill="none">
                <path d="M10,80 Q30,10 80,60" stroke="currentColor" strokeWidth="2.5" strokeDasharray="4 4" />
                <path d="M78,58 Q85,55 82,65 Q75,68 78,58 Z" fill="currentColor" />
              </svg>
            </div>
            ...
            <div className="relative z-10">
              <div className="relative w-[280px] h-[330px] xs:w-[320px] xs:h-[360px] sm:w-[420px] sm:h-[460px] md:w-[440px] md:h-[480px] lg:w-[380px] lg:h-[420px] xl:w-[460px] xl:h-[490px] rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden shadow-xs">
                ...
                <div className="absolute top-3 left-3 sm:top-5 sm:left-5 z-20">
                  <svg className="w-7 h-7 sm:w-9 sm:h-9 text-[#133d20] -rotate-12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
