...
export default function EnquirySec() {
  ...
  const { badge, heading, description, features, getInTouch, form } = enquiryData;
            ...
            <div className="rounded-2xl border border-[#e2ece0] bg-[#f0f6ef] p-6 shadow-sm max-w-sm">
              ...
              <div className="space-y-3 text-xs sm:text-sm text-[#16351d]">
                <div className="flex items-center gap-3">
                  ...
                  <a href={`tel:${getInTouch.phone}`} className="font-semibold hover:underline">
                    {getInTouch.phone}
                  </a>
                </div>
                <div className="flex items-center gap-3">
                  <Mail className="h-4 w-4 text-[#1d5e2d] shrink-0" />
                  <a href={`mailto:${getInTouch.email}`} className="font-semibold hover:underline">
                    {getInTouch.email}
                  </a>
                </div>
