...
export default function CaseStudySection() {
  const caseStudyData = data.caseStudySection as NgoCaseStudySection | undefined;
      ...
      <div className="mx-auto max-w-[1380px] px-4 sm:px-6 lg:px-8 pb-6">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-2.5 sm:gap-3">
          {caseStudyData.categories.map((category) => {
            ...
            const CategoryIcon = iconMap[category.value as keyof typeof iconMap] ?? LayoutGrid;
            ...
            return (
              ...
              >
                <CategoryIcon className={`h-4 w-4 ${isActive ? 'text-white' : 'text-[#234b2c]'}`} />
        ...
        {/* 3 Columns Grid for Desktop (`lg:grid-cols-3`) */}
        <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {filteredCards.map((card: NgoCaseStudyCard) => (
            ...
            >
              <div>
                {/* Image Container + Floating Round Icon Badge */}
                <div className="relative h-52 w-full overflow-hidden rounded-t-2xl">
                  ...
                  {/* Floating White Circle Icon in Top Left */}
