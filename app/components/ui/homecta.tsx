...
const data = {
  homeCta: (ngoDataJson as any).NGO.sections.homeCta?.variants?.Legacy_homeCta,
};
        ...
        <div className="relative bg-[#102719] rounded-2xl py-8 px-6 sm:px-10 lg:px-8 shadow-2xl overflow-hidden">
          <div className="absolute right-0 top-0 bottom-0 opacity-20 pointer-events-none hidden lg:block">
            ...
            >
              ...
              <path
                d="M165,30 C140,25 130,10 145,5 C155,18 165,30 165,30 Z"
                fill="currentColor"
                opacity="0.3"
              />
              <path
                d="M150,55 C125,50 115,35 130,30 C140,43 150,55 150,55 Z"
                fill="currentColor"
                opacity="0.3"
              />
              <path
                d="M142,80 C117,75 107,60 122,55 C132,68 142,80 142,80 Z"
                fill="currentColor"
                opacity="0.3"
              />
              <path
                d="M155,105 C130,100 120,85 135,80 C145,93 155,105 155,105 Z"
                fill="currentColor"
                opacity="0.3"
              />
            </svg>
