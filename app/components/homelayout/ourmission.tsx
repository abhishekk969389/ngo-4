...
export default function OurMission() {
  ...
  const getCardIcon = (iconName: string) => {
    switch (iconName) {
      case 'child':
        return (
          <svg viewBox="0 0 24 24" className="w-8 h-8 text-[#1f5e2e] fill-none stroke-current stroke-2">
            <path d="M12 7c-1.5-2-4-2-5.5-.5S6 10.5 12 16c6-5.5 7-7.5 5.5-9.5S13.5 5 12 7z" className="fill-[#1f5e2e]/10" />
      ...
      case 'food':
        return (
          <svg viewBox="0 0 24 24" className="w-8 h-8 text-[#1f5e2e] fill-none stroke-current stroke-2">
            <path d="M4 11h16a1 1 0 0 1 1 1c0 4.4-3.6 8-8 8s-8-3.6-8-8a1 1 0 0 1 1-1z" className="fill-[#1f5e2e]/10" />
